...
//if(flag==1){
	...
	query = "select P.p_gls_id, P.pnl_id, D.defect_no, D.defect_code, D.coor_x, D.coor_y from pnl_tbl P,(select * from dft_tbl where defect_code in (?)) D where D.d_pnl_id = P.pnl_id and P.p_gls_id ='"+glass_id+"'";
	pstmt = conn.prepareStatement(query);
		
//		for(i=0; i<defect_code_array.length; i++){
			pstmt.setString(1, defect_code);
//		}
		
//		pstmt.setString(2, glass_id);
